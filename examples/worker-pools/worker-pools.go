...
func main() {
	...
	// робітнику, а з іншого отримувати результати роботи.
	const numJobs = 5
	jobs := make(chan int, numJobs)
	results := make(chan int, numJobs)

	// Спершу - запускаємо 3 функції-працівника, які блокуватимуться
